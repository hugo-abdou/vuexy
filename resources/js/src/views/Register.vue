                        ...
                        <b-form class="auth-register-form mt-2" @submit.prevent="register">
                            ...
                            <b-form-group label="Email" label-for="register-email">
                                <validation-provider #default="{ errors }" name="Email" vid="email" rules="required|email">
                                    <b-form-input id="register-email" v-model="email" name="register-email" :state="errors.length > 0 ? false : null" placeholder="john@example.com" />
                                    <small class="text-danger">{{ errors[0] }}</small>
                                </validation-provider>
                            </b-form-group>
                            ...
                            <!-- confirm password -->
                            <b-form-group label-for="password-confirmation" label="Confirm Password">
                                <validation-provider #default="{ errors }" name="Password" vid="password_confirmation" rules="required">
                                    <b-input-group class="input-group-merge" :class="errors.length > 0 ? 'is-invalid' : null">
                                        <b-form-input
